...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; - If this fails to find the file you will have to tell it where the requirements is. For example "pip install C:\usr\downloads\BookmarksToPDF\Main\requirements.txt" <br>
- Run the program <br>
